...
const groups: { title: string; subtitle: string; items: Program[] }[] = [
  ...
  {
    title: "Латинская Америка — гражданство по рождению",
    subtitle: "Ускоренные программы для семьи и ребёнка в Чили, Аргентине, Перу",
    items: [
      {
        flag: "🇨🇱",
        country: "Чили",
        ...
        bullets: ["Паспорт малышу при рождении", "ВНЖ родителям сразу", "Гражданство за 2 года"],
      ...
      },
      {
        ...
        country: "Перу",
        visa: "Гражданство по рождению",
        desc: "Гражданство по jus soli ребёнку и ускоренная натурализация родителям через 2 года.",
        bullets: ["Паспорт малышу при рождении", "ВНЖ всей семье", "Гражданство за 2 года"],
    ...
    items: [
      {
        ...
        img: "https://images.unsplash.com/photo-1589307357824-9d2e7da0a8b1?w=900&q=80&auto=format&fit=crop",
      },
      {
        flag: "🇮🇱",
        country: "Израиль",
