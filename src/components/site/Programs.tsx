...
const groups: { title: string; subtitle: string; note?: string; items: Program[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        img: "https://images.unsplash.com/photo-1564594985645-4427056e22e2?w=900&q=80&auto=format&fit=crop",
        tag: "Без выезда",
      },
      {
        flag: "🇵🇹",
  ...
  {
    title: "Репатриация по корням",
    subtitle: "Армянская и израильская программы — гражданство по происхождению",
